...
def single_file(url_dir,filename,save_to,ftp_root=False,
                overwrite=False,verbose=True,auth=None):
    ...
    try:
        ...
        if not ftp_root:
            ...
            if filename in contents:
                ...
                # DB added progressbar for download <-
                size = ftp.size(filename)
                widgets = ['Downloading: ', filename, ' ',
