...
%%% - Missing depth data
%%% - Lat/lon have been made by interpolation
...
netcdf.putAtt(ncid_O2, varid_O2, 'units', 'micromoles/L')
...
netcdf.putAtt(ncid_chl, varid_chl, 'units', 'micromoles/L')
...
netcdf.putAtt(ncid_bbp, varid_bbp470, 'units', '-')
netcdf.putAtt(ncid_bbp, varid_bbp470, 'standard_name', 'Backscatter 470nm')
netcdf.putAtt(ncid_bbp, varid_bbp700, 'units', '-')
